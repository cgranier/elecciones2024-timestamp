...
ax.plot(df['adjusted_time'], df['EG_cumulative'], label='EG', color='blue')
ax.plot(df['adjusted_time'], df['NM_cumulative'], label='NM', color='red')
...
ax.set_title('Cumulative Votes for EG and NM Over Time')
